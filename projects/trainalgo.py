...
def process():
        ...
        size=300
         ...
         ## load Training data : Cancerous
        potholeTrainImages = glob.glob("./Dataset/Train/Cancerous/*.jpg")
        potholeTrainImages.extend(glob.glob("./Dataset/Train/Cancerous/*.jpeg"))
        potholeTrainImages.extend(glob.glob("./Dataset/Train/Cancerous/*.png"))
        ...
        nonPotholeTrainImages = glob.glob("./Dataset/Train/Normal/*.png")
        ...
        nonPotholeTestImages = glob.glob("./Dataset/Test/Normal/*.png")
        # nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpeg"))
        # nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.png"))
        ...
        potholeTestImages = glob.glob("./Dataset/Test/Cancerous/*.png")
        # nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpeg"))
        # nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.png"))
        ...
        model.save('latest_full_model1.h5')
